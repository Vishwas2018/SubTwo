...
// ─── Scenario 2: Invalid code format — Zod schema rejects (no Supabase needed) ──────────────
...
// ─── Supabase scenarios — skipped in CI when SUPABASE_URL is absent ──────────────────────────

describe.skipIf(!SUPABASE_AVAILABLE)('Signup integration — Supabase scenarios', () => {
